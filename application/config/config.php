...
|
// */
$config['base_url'] = 'http://localhost/BarangayDataProfiling/';

//$config['base_url'] = 'https://testing-bicto.bangsamoro.gov.ph/dtlc/';
/*
|------------   --------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['encryption_key'] = 'd07cf4285997a7d3e5e5cf0ac880ec88';
